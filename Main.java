...
public class Main {
    public static void main(String[] args) {
        ...
        OverDraftAccount overdraftAccount = new OverDraftAccount(1000.0, 2000.0);
        System.out.println("Αρχικό υπόλοιπο λογαριασμού υπερανάληψης: " + overdraftAccount.OverDraftAccountToString());

        try {
            boolean result = overdraftAccount.withdraw(2200.0);
            if (result) {
                System.out.println("Υπόλοιπο μετά από ανάληψη 2200: " + overdraftAccount.getBalance());
            } else {
        ...
        try {
            boolean result = jointAccount.withdraw(300.0);
            if (result) {
